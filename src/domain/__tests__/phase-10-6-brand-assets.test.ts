...
describe("Phase 10.6 brand assets and live table polish", () => {
  ...
  it("exposes Live Standings in navigation, Dashboard, and the detailed standings page", () => {
    ...
    expect(source("src/components/dashboard-control-center.tsx")).toContain('<Link href="/live-standings" className="dashboard-live-table-heading-pill">Full Live Standings');
