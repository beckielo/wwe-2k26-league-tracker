...
export default async function LegacyPage({ searchParams }: { searchParams?: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <>
    <header className="legacy-hero">
      ...
      <div><p className="eyebrow">Workbook-backed career archive</p><h1>Legacy Table</h1><p>All-time achievements with a validated {data.historicalAnalytics.split} current-context overlay.</p></div>
