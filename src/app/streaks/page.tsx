...
export default function StreaksPage() {
  ...
  return <>
    ...
    {analytics.winningStreakSheetStatus === "reconstructed" && <div className="mb-6 border border-amber-400/30 bg-amber-400/10 p-4 text-sm text-amber-200">The workbook streak sheet was stale. This view safely uses the validated current-context reconstruction.</div>}
