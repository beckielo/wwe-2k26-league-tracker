...
export default function SimulationPage() {
  ...
  return <>
    <PageHeader eyebrow="Phase 3B · active non-user shows" title="Simulation Studio" description={`Generate explainable previews only for open non-user league matches in the active app week. ${data.meta.userLeague} remains excluded.`} />
